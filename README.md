...
A acupuncture meridian version of Gabriele Cirulli's [original 2048](http://gabrielecirulli.github.io/2048/). 
...
### Notes for the Acupuncture version
The flow of the meridians is similar to the flow on textbooks, running from LU meridian to LR meridian. Thus, playing this game helps to strengthen your memory on the flow of the meridians.
